...
window.I18N_STRINGS = {
    ...
    // can reach it.
    'game.levels': { en: 'Levels', mn: 'Түвшингүүд' },
    'game.time': { en: 'Time', mn: 'Хугацаа' },
    'game.startMatch': { en: 'Start Match', mn: 'Тоглоом эхлүүлэх' },
    'game.backToLevels': { en: 'Back to Levels', mn: 'Түвшингүүд рүү буцах' },
    'game.logInToSave': { en: 'Log In to Save', mn: 'Хадгалахын тулд нэвтрэх' },
    'game.levelComplete': { en: 'Level Complete!', mn: 'Түвшин дууслаа!' },
    'game.timesUp': { en: "Time's Up!", mn: 'Цаг дууслаа!' },
    'game.firstClear': { en: 'First clear on this level!', mn: 'Энэ түвшинг анх удаа дуусгалаа!' },
    'game.nextLevel': { en: 'Next Level', mn: 'Дараагийн түвшин' },
    ...
    'nav.allLevels': { en: 'All Levels', mn: 'Бүх түвшин' },
